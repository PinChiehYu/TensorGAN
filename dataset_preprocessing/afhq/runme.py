...
dataset_tool_path = os.path.join(eg3d_root, 'tensorGAN', 'dataset_tool.py')
...
with tempfile.TemporaryDirectory() as working_dir:
    ...
    with open(f'{working_dir}/cat_images/dataset.json', "r") as f:
        dataset = json.load(f)
    
    for i in dataset['labels']:
        i[0] = i[0].replace(".png", ".jpg")

    with open(f'{working_dir}/cat_images/dataset.json', 'w') as f:
        json.dump(dataset, f)
